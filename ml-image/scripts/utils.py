...
class ImageDataset(Dataset):
    ...
    def __init__(self, image_array, transform):
        ...
        # Please change the transformation (resize, normalize...) to comply w/ the used model
...
def get_data_from_url(url: str,
    ...
    data = {"url": url, "poster_path": poster_path, "trailer_path": video_path,
            "image": Image.open(poster_path), "quality": quality}
