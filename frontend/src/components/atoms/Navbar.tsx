...
const Navbar = () => {
  ...
  return (
    <nav className={`text-white fixed w-full ${isOpen ? "flex flex-col h-full bg-zinc-800" : ""} md:bg-transparent`}>
      ...
      <div className="max-w-7xl mx-auto px-4 w-full">
        ...
        {isSearching &&
          ...
          <div
          className="fixed inset-0 bg-grey backdrop-blur-xl z-10"
