...
import { Award, Festival, Nomination } from "./festival";
            ...
            <>
              <div className="flex gap-5 py-5">
                ...
                >
                  <CardHeader>
                    <CardTitle className="text-2xl text-violet-300">
                      {typeof festivalData.festival_metrics.prizes_awarded_to_women[selectedYear] == "number"
                        ? `${festivalData.festival_metrics.prizes_awarded_to_women[selectedYear]} %`
                        : "NC"}
                    </CardTitle>
                    <CardDescription className="text-white">
                ...
                >
                  <CardHeader>
                    <CardTitle className="text-2xl text-violet-300">
                      {typeof festivalData.festival_metrics.produced_by_women[selectedYear] == "number"
                        ? `${festivalData.festival_metrics.produced_by_women[selectedYear]} %`
                        : "NC"}
                    </CardTitle>
                    <CardDescription className="text-white">
