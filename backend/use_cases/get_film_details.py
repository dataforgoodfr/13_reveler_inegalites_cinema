...
class GetFilmDetails:
    ...
    def execute(self, film_id: int) -> dict:
        ...
        film_data["poster_image_base64"] = film.poster.image_base64 if film.poster else None
        film_data["trailer_url"] = film.trailer.trailer_url if film.trailer else None
