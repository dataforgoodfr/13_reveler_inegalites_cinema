...
class AllocineFilmMatcher:
    ...
    """
    CSV_HEADERS = ["film_id", "original_name", "cnc_agrement_year", "allocine_id", "allocine_title", "allocine_url"]
    ...
    async def run(self):
        ...
        if file_exists:
            with open(self.csv_path, mode="r", encoding="utf-8") as f:
                ...
                existing_names = {row["original_name"] for row in reader}
        ...
        with open(self.csv_path, mode="a", newline="", encoding="utf-8") as csvfile:
            ...
            for film in tqdm(films, desc="Searching Allociné"):
                ...
                try:
                    ...
                    writer.writerow([film.id, original_name, cnc_agrement_year, "Error", "Error", str(e)])
